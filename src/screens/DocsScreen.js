...
const DocsScreen = ({ route, navigation }) => {
  ...
  const getTranslatedText = (key) => {
    return (
      translations[key] ||
      textsToTranslate[key][languageCode] ||
      textsToTranslate[key].en
    );
  };
  ...
  const handleOptionPress = (option) => {
    ...
    const options = {
      e8Registration: [
        ...
        textsToTranslate.e8Registration.en,
      ],
      e8Extension: [
        getTranslatedText("e8Extension"),
        textsToTranslate.e8Extension.en,
      ],
      e8WorkplaceChange: [
        getTranslatedText("e8WorkplaceChange"),
        textsToTranslate.e8WorkplaceChange.en,
      ],
      e9Registration: [
        getTranslatedText("e9Registration"),
        textsToTranslate.e9Registration.en,
      ],
      e9WorkplaceChange: [
        getTranslatedText("e9WorkplaceChange"),
        textsToTranslate.e9WorkplaceChange.en,
      ],
      e9Extension: [
        getTranslatedText("e9Extension"),
        textsToTranslate.e9Extension.en,
      ],
      complaintForm1: [
        getTranslatedText("complaintForm1"),
        textsToTranslate.complaintForm1.en,
      ],
      complaintForm2: [
        getTranslatedText("complaintForm2"),
        textsToTranslate.complaintForm2.en,
      ],
    };
    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.header}>
        <Image
          ...
          resizeMode="contain"
        />
        <Text style={styles.headerTitle}>{getTranslatedText("title")}</Text>
      </View>
