...
const textsToTranslate = {
  ...
  extendVisaExpiredMessage:
    "The extension period has expired. You need to get a new visa.",
...
const koreanTranslations = {
  ...
  extendVisaExpiredMessage:
    "연장 기간이 만료되었습니다. 새로운 비자를 발급받아야 합니다.",
...
const MyPageScreen = ({ navigation, route }) => {
  ...
  const translateTexts = async () => {
    ...
    try {
      console.log(
        "Translating texts:",
        Object.keys(textsToTranslate).length,
        "items"
      );
  ...
  const fetchUserInfo = async () => {
    try {
      ...
      if (response.ok) {
        ...
        Alert.alert(
          "오류",
          data.error || "사용자 정보를 불러오는데 실패했습니다."
        );
      }
    } catch (error) {
  ...
  const fetchApplicationsSummary = async () => {
    try {
      ...
      if (response.ok) {
        ...
        const convertedRecentApplications = data.recent_applications.map(
          (app) => ({
            ...app,
            application_type:
  ...
  const handleResidenceCardModify = async () => {
    try {
      ...
      if (response.ok) {
        ...
        Alert.alert(
          "오류",
          data.error || "외국인 등록증 정보를 가져오는데 실패했습니다."
        );
      }
    } catch (error) {
  ...
  const calculateDaysLeft = (expiryDate, extensionEnd) => {
    ...
    const targetDate =
      extensionEnd && new Date(extensionEnd) > new Date(expiryDate)
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            <Text style={styles.sectionTitle}>
              {translations.myApplications || textsToTranslate.myApplications}
            </Text>
          </View>
        ...
        <View style={styles.section}>
          ...
          >
            ...
            <Text style={styles.emptyApplicationsText}>
              {translations.noApplications || textsToTranslate.noApplications}
            </Text>
            <Text style={styles.emptyApplicationsSubText}>
              {translations.apply || textsToTranslate.apply}
            </Text>
          </TouchableOpacity>
        </View>
      );
        ...
        <View style={[styles.sectionHeader, styles.sectionHeaderWithMore]}>
          ...
          >
            <Text style={styles.moreButtonText}>
              {translations.more || textsToTranslate.more}
            </Text>
          ...
          {recentApplications.map((app) => (
            <View key={app.id} style={styles.recentApplicationItem}>
              ...
              <Text style={styles.recentApplicationDate}>
                {translations.applicationDate}:{" "}
                {new Date(app.created_at).toLocaleDateString(
                  languageCode === "ko" ? "ko-KR" : "en-US"
                )}
              </Text>
            </View>
          ))}
    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>
          {translations.myPage || textsToTranslate.myPage}
        </Text>
        <Text style={styles.headerSubtitle}>
          {(
            translations.welcomeMessage || textsToTranslate.welcomeMessage
      ...
      <ScrollView style={styles.container}>
          ...
          <View style={styles.infoContainer}>
            <View style={styles.infoRow}>
              <Text style={styles.infoLabel}>
                {translations.name || textsToTranslate.name}
              </Text>
              <Text style={styles.infoValue}>{userInfo?.name || "-"}</Text>
            </View>
            <View style={styles.infoRow}>
              <Text style={styles.infoLabel}>
                {translations.id || textsToTranslate.id}
              </Text>
              <Text style={styles.infoValue}>{userInfo?.username || "-"}</Text>
            </View>
            <View style={styles.infoRow}>
              <Text style={styles.infoLabel}>
                {translations.birthDate || textsToTranslate.birthDate}
              </Text>
            ...
            <View style={styles.infoRow}>
              <Text style={styles.infoLabel}>
                {translations.email || textsToTranslate.email}
              </Text>
        ...
        <View style={styles.section}>
          ...
          {userInfo?.passport ? (
            <View style={styles.infoCard}>
              <View style={styles.infoRow}>
                <Text style={styles.infoLabel}>
                  {translations.passportSurname ||
                    textsToTranslate.passportSurname}
                </Text>
                <Text style={styles.infoValue}>
                  {userInfo.passport.surname}
                </Text>
              </View>
              <View style={styles.infoDivider} />
              <View style={styles.infoRow}>
                <Text style={styles.infoLabel}>
                  {translations.passportGivenName ||
                    textsToTranslate.passportGivenName}
                </Text>
                <Text style={styles.infoValue}>
                  {userInfo.passport.givenname}
                </Text>
              </View>
              <View style={styles.infoDivider} />
              <View style={styles.infoRow}>
                <Text style={styles.infoLabel}>
                  {translations.passportNumber ||
                    textsToTranslate.passportNumber}
                </Text>
                <Text style={styles.infoValue}>
                  {userInfo.passport.passport_number}
                </Text>
              </View>
              <View style={styles.infoDivider} />
              <View style={styles.infoRow}>
                <Text style={styles.infoLabel}>
                  {translations.passportNationality ||
                    textsToTranslate.passportNationality}
                </Text>
                <Text style={styles.infoValue}>
                  {userInfo.passport.nationality}
                </Text>
              </View>
              <View style={styles.infoDivider} />
              <View style={styles.infoRow}>
              ...
              <View style={styles.infoRow}>
                <Text style={styles.infoLabel}>
                  {translations.passportIssueDate ||
                    textsToTranslate.passportIssueDate}
                </Text>
                <Text style={styles.infoValue}>
                  {userInfo.passport.issue_date}
                </Text>
              </View>
              <View style={styles.infoDivider} />
              <View style={styles.infoRow}>
                <Text style={styles.infoLabel}>
                  {translations.passportExpiryDate ||
                    textsToTranslate.passportExpiryDate}
                </Text>
                <Text style={styles.infoValue}>
                  {userInfo.passport.expiry_date}
                </Text>
              </View>
              <TouchableOpacity
                style={styles.editButton}
            ...
            <View style={styles.emptyCard}>
              ...
              >
                ...
                <Text style={styles.addButtonText}>
                  {translations.registerPassport ||
                    textsToTranslate.registerPassport}
                </Text>
              </TouchableOpacity>
            </View>
          )}
        ...
        <View style={styles.section}>
          ...
          {userInfo?.residence_card ? (
            <View style={styles.infoCard}>
              <View style={styles.infoRow}>
                <Text style={styles.infoLabel}>
                  {translations.residenceNameKor ||
                    textsToTranslate.residenceNameKor}
                </Text>
                <Text style={styles.infoValue}>
                  {userInfo.residence_card.name_kor}
                </Text>
              </View>
              <View style={styles.infoDivider} />
              <View style={styles.infoRow}>
                ...
                <Text style={styles.infoValue}>
                  {userInfo.residence_card.resident_id}
                </Text>
              </View>
              <View style={styles.infoDivider} />
              <View style={styles.infoRow}>
                <Text style={styles.infoLabel}>
                  {translations.residenceVisaType ||
                    textsToTranslate.residenceVisaType}
                </Text>
                <Text style={styles.infoValue}>
                  {userInfo.residence_card.visa_type}
                </Text>
              </View>
              <View style={styles.infoDivider} />
              <View style={styles.infoRow}>
                <Text style={styles.infoLabel}>
                  {translations.residenceIssueDate ||
                    textsToTranslate.residenceIssueDate}
                </Text>
                <Text style={styles.infoValue}>
                  {userInfo.residence_card.issue_date}
                </Text>
              </View>
              <TouchableOpacity
                style={styles.editButton}
            ...
            <View style={styles.emptyCard}>
              ...
              >
                ...
                />
                <Text style={styles.addButtonText}>
                  {translations.registerResidence ||
                    textsToTranslate.registerResidence}
                </Text>
              </TouchableOpacity>
            </View>
          )}
        ...
        <View style={styles.section}>
          ...
          <View style={styles.infoContainer}>
            <View style={styles.infoRow}>
              <Text style={styles.infoLabel}>
                {translations.visaType || textsToTranslate.visaType}
              </Text>
              <Text style={styles.infoValue}>
                {userInfo?.visa?.visa_type || "-"}
              </Text>
            </View>
            <View style={styles.infoRow}>
              <Text style={styles.infoLabel}>
                {translations.entryDate || textsToTranslate.entryDate}
              </Text>
              <Text style={styles.infoValue}>
                {userInfo?.visa?.entry_date || "-"}
              </Text>
            ...
            <View style={styles.infoRow}>
              <Text style={styles.infoLabel}>
                {translations.visaExpiry || textsToTranslate.visaExpiry}
              </Text>
              <Text style={styles.infoValue}>
                {userInfo?.visa?.expiry_date || "-"}
              </Text>
            ...
            <View style={styles.infoRow}>
              <Text style={styles.infoLabel}>
                {translations.stayProgress || textsToTranslate.stayProgress}
              </Text>
            ...
            <View style={styles.infoRow}>
              <Text style={styles.infoLabel}>
                {translations.daysLeft || textsToTranslate.daysLeft}
              </Text>
              <Text style={styles.infoValue}>D-{daysLeft}</Text>
            </View>
            <View style={styles.infoRow}>
              <Text style={styles.infoLabel}>
                {translations.extensionStart || textsToTranslate.extensionStart}
              </Text>
              <Text style={styles.infoValue}>
            ...
            <View style={styles.infoRow}>
              <Text style={styles.infoLabel}>
                {translations.extensionEnd || textsToTranslate.extensionEnd}
              </Text>
              <Text style={styles.infoValue}>
                {userInfo?.visa?.extension_end || "-"}
              </Text>
            ...
            <View style={styles.infoRow}>
              <Text style={styles.infoLabel}>
                {translations.extensionCount || textsToTranslate.extensionCount}
              </Text>
              <Text style={styles.infoValue}>
                {userInfo?.visa?.extension_count || 0}회
              </Text>
            </View>
          </View>
        ...
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            <Text style={styles.modalTitle}>
              {translations.editBasicInfoTitle ||
                textsToTranslate.editBasicInfoTitle}
            </Text>

            <View style={styles.inputContainer}>
              <Text style={styles.label}>
                {translations.editBasicInfoName ||
                  textsToTranslate.editBasicInfoName}
              </Text>
              <TextInput
                style={styles.input}
                value={editName}
                ...
                placeholder={
                  translations.editBasicInfoNamePlaceholder ||
                  textsToTranslate.editBasicInfoNamePlaceholder
                }
              />
            </View>
            ...
            <View style={styles.inputContainer}>
              <Text style={styles.label}>
                {translations.editBasicInfoUsername ||
                  textsToTranslate.editBasicInfoUsername}
              </Text>
              <TextInput
                style={styles.input}
                value={editUsername}
                ...
                placeholder={
                  translations.editBasicInfoUsernamePlaceholder ||
                  textsToTranslate.editBasicInfoUsernamePlaceholder
                }
                autoCapitalize="none"
              />
            </View>
            ...
            <View style={styles.inputContainer}>
              <Text style={styles.label}>
                {translations.editBasicInfoBirthDate ||
                  textsToTranslate.editBasicInfoBirthDate}
              </Text>
              <TextInput
                style={styles.input}
                value={editBirthDate}
                ...
                placeholder={
                  translations.editBasicInfoBirthDatePlaceholder ||
                  textsToTranslate.editBasicInfoBirthDatePlaceholder
                }
            ...
            <View style={styles.inputContainer}>
              <Text style={styles.label}>
                {translations.editBasicInfoEmail ||
                  textsToTranslate.editBasicInfoEmail}
              </Text>
              <TextInput
                style={styles.input}
                value={editEmail}
                ...
                placeholder={
                  translations.editBasicInfoEmailPlaceholder ||
                  textsToTranslate.editBasicInfoEmailPlaceholder
                }
                autoCapitalize="none"
        ...
        <TouchableWithoutFeedback onPress={() => Keyboard.dismiss()}>
          <View style={styles.modalContainer}>
            <TouchableWithoutFeedback onPress={(e) => e.stopPropagation()}>
              <View style={styles.modalContent}>
                <Text style={styles.modalTitle}>
                  {translations.editVisaInfoTitle ||
                    textsToTranslate.editVisaInfoTitle}
                </Text>

                <View style={styles.inputContainer}>
                  <Text style={styles.label}>
                    {translations.editVisaInfoType ||
                      textsToTranslate.editVisaInfoType}
                  </Text>
                    ...
                    >
                      <Text
                        style={[
                          ...
                          editVisaType === "E-8" &&
                            styles.visaTypeButtonTextSelected,
                        ]}
                      >
                        E-8
                      </Text>
                ...
                <View style={styles.inputContainer}>
                  <Text style={styles.label}>
                    {translations.editVisaInfoEntryDate ||
                      textsToTranslate.editVisaInfoEntryDate}
                  </Text>
                  <TextInput
                    style={styles.input}
                    value={editEntryDate}
                    ...
                    placeholder={
                      translations.editVisaInfoEntryDatePlaceholder ||
                      textsToTranslate.editVisaInfoEntryDatePlaceholder
                    }
                    keyboardType="numeric"
                    maxLength={10}
                ...
                <View style={styles.infoContainer}>
                  <View style={styles.infoRow}>
                    <Text style={styles.infoLabel}>
                      {translations.editVisaInfoExpiryDate ||
                        textsToTranslate.editVisaInfoExpiryDate}
                    </Text>
                    <Text style={styles.infoValue}>
                      {editVisaExpiry || "-"}
                    </Text>
                  ...
                  <View style={styles.infoRow}>
                    <Text style={styles.infoLabel}>
                      {translations.editVisaInfoExtensionStart ||
                        textsToTranslate.editVisaInfoExtensionStart}
                    </Text>
                    <Text style={styles.infoValue}>
                      {editExtensionStart || "-"}
                    </Text>
                  ...
                  <View style={styles.infoRow}>
                    <Text style={styles.infoLabel}>
                      {translations.editVisaInfoExtensionEnd ||
                        textsToTranslate.editVisaInfoExtensionEnd}
                    </Text>
                    <Text style={styles.infoValue}>
                      {editExtensionEnd || "-"}
                    </Text>
        ...
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            ...
            <Text style={styles.modalText}>
              {translations.extendVisaMessage ||
                textsToTranslate.extendVisaMessage}
              {userInfo?.visa?.visa_type === "E-8"
                ? translations.extendVisaE8Message ||
                  textsToTranslate.extendVisaE8Message
                : translations.extendVisaE9Message ||
                  textsToTranslate.extendVisaE9Message}
              {userInfo?.visa?.extension_end &&
              new Date(userInfo.visa.extension_end) < new Date()
                ? translations.extendVisaExpiredMessage ||
                  textsToTranslate.extendVisaExpiredMessage
                : translations.extendVisaAvailableMessage ||
                  textsToTranslate.extendVisaAvailableMessage}
            </Text>
            <View style={styles.modalButtons}>
              <TouchableOpacity
                style={[styles.modalButton, styles.cancelButton]}
          ...
          <View style={styles.modalContent}>
            ...
            <Text style={styles.modalText}>
              {translations.deleteAccountWarning ||
                textsToTranslate.deleteAccountWarning}
            </Text>
            <TextInput
              style={styles.modalInput}
              placeholder={
                translations.enterPassword || textsToTranslate.enterPassword
              }
